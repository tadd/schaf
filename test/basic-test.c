...
#define clear_error_message() ((char *)sch_error_message())[0] = '\0'// dirty hack
#define expect_runtime_error(exp, act) expect_error(exp, sch_eval_string(act)); clear_error_message()
