...
(describe "dynamic-wind 1" (lambda ()
  (define (f)
    (let ((l (list))
          (k #f))
      (let ((append-l (lambda (x)
...
(describe "dynamic-wind 2-1" (lambda ()
  (define (f)
    (let ((l (list))
          (k #f))
      (let ((append-l (lambda (x)
...
(xdescribe "dynamic-wind 2-2" (lambda ()
  (define (f)
    (let ((l (list))
          (k #f))
      (let ((append-l (lambda (x)
        ...
        (dynamic-wind
            ...
            (lambda () (append-l 'c)))
        l)))
  (expect equal? (f) '(a b c K 3))))

(describe "dynamic-wind 3-1" (lambda ()
  (define (f)
    (let ((l (list))
          (k #f))
      (let ((append-l (lambda (x)
        ...
        (dynamic-wind
            ...
            (lambda ()
              (append-l 1)
              (append-l (call/cc (lambda (c) (set! k c) 2)))
              (append-l 3))
            (lambda () (append-l 'c)))
        l)))
  (expect equal? (f) '(a 1 2 3 c))))

(xdescribe "dynamic-wind 3-2" (lambda ()
  (define (f)
    (let ((l (list))
          (k #f))
      (let ((append-l (lambda (x)
