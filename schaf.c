...
static void define_procedure_typed(Table *env, const char *name, void *cfunc,
                                   int64_t arity, ...)
{
    expect_cfunc_arity(arity);
...
static void define_syntax_typed(Table *env, const char *name, void *cfunc,
                                int64_t arity, ...)
{
    expect_cfunc_arity(arity);
    int8_t types[CFUNCARG_MAX];
