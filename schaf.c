...
static void define_syntaxes(Value e)
{
    // 4. Expressions
...
// 6. Standard procedures
static void define_procedures(Value e)
{
    // 6.1. Equivalence predicates
...
// Extensions from R7RS
static void define_extension_procedures_r7rs(Value e)
{
    // (scheme base)
...
static void define_extension_procedures_local(Value e)
{
...
#define DEF_SYMBOL(var, name) SYM_##var = sch_symbol_new(name)
    ...
    // Extensions
    define_extension_procedures_r7rs(e);
    define_extension_procedures_local(e);
