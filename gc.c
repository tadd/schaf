...
static const GCAlgorithmData GC_ALGO_DATA_GREEN_TEA = {
    .init = gt_init,
    .fin = ms_fin,
    .malloc = gt_malloc,
    .add_root = ms_add_root,
...
static const GCAlgorithmData GC_ALGO_DATA_DEFAULT = GC_ALGO_DATA_GREEN_TEA;
